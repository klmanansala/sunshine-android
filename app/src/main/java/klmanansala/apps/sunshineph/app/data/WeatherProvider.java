...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getAllWeather(String[] projection, String selection, String[] selectionArgs,
                                 String sortOrder) {
    ...
    private Cursor getAllLocation(String[] projection, String selection, String[] selectionArgs,
                                  String sortOrder) {
        return mOpenHelper.getReadableDatabase().query(
                WeatherContract.LocationEntry.TABLE_NAME,
                projection,
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getAllWeather(projection, selection, selectionArgs, sortOrder);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getAllLocation(projection, selection, selectionArgs, sortOrder);
                break;
            }
